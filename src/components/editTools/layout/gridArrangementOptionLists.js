...
function menu(f) {
  return (
    <Menu>
    {[[6,6],[4,8],[8,4],[4,4,4], [4,4,2,2],[6,3,3],[2,2,2,2,2,2]].map(item => 
...
export default class GridArrangementOptionLists extends React.Component {
  constructor(props, context) {
    super(props);
    this.positionStyle = this.props.positionStyle || { position: 'absolute', left: 0, top: -37, "borderRadius": "10%", "background": "#303233" }
  }
